    ...
    public class CustomTest
    {
        ...
        /*  DataRepository dataRepositoryTest = new DataRepository();
            ...
            /*
                        ...
                        if (!dataRepositoryTest.GetKatalog(1).ToString().Equals(new Katalog(1, "Harry Potter", "JKK Rowling", "1995", (float)33.5).ToString())) Assert.Fail();
                        if (dataRepositoryTest.GetWykaz(0).ToString().Equals(new Katalog(1, "nie", "cos", "tak", (float)33.5).ToString())) Assert.Fail();
            */
        }
    }
}
